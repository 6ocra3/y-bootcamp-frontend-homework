    ...
    return <div className={bem()}>
        ...
        <nav className="navbar navbar-expand-sm navbar-light bg-light">
            <div className="container">
                <Link data-testid="home-link" className={bem('Brand', ['navbar-brand'])} to="/">Example store</Link>
                <button data-testid="burger-btn" className={bem('Toggler', ['navbar-toggler'])} aria-label="Toggle navigation" onClick={toggle}>
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div data-testid="links-div" className={bem('Menu', [navbarClass])}>
